...
const char * LIB_PATH_VALUE   = "C:\\Users\\Nascimento\\workspace\\MolShaCS_2\\src\\libs\\gsl-2.5\\cblas\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\Users\\Nascimento\\workspace\\MolShaCS_2\\src\\libs\\gsl-2.5\\cblas\\.libs;C:\\Users\\Nascimento\\workspace\\MolShaCS_2\\lib\\gsl\\lib;C:\\Users\\Nascimento\\workspace\\MolShaCS_2\\lib\\gsl\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /c/Users/Nascimento/workspace/MolShaCS_2/src/libs/gsl-2.5/c", f);
  fputs ("blas/libgslcblas.la cblas/libgslcblas.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"gsl-randist.exe:gsl-randist:${LINENO}: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gsl-randist.exe:gsl-randist:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gsl-randist.exe:gsl-randist:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("    PATH=/c/Users/Nascimento/workspace/MolShaCS_2/src/libs/gsl-2.5/cblas/.libs:", f);
  fputs ("/c/Users/Nascimento/workspace/MolShaCS_2/lib/gsl/lib:/c/Users/Nascimento/worksp", f);
  fputs ("ace/MolShaCS_2/lib/gsl/bin:$PATH\n", f);
  fputs ("\n", f);
